...
const SITE_STYLES: Record<string, {
    ...
    site02: {
        ...
        overlayFrom: 'from-[#2FB5AD]/20',
        overlayTo: 'from-[#6EC6C0]/20',
        accentBar: 'from-[#2FB5AD] to-[#6EC6C0]',
        buttonGradient: 'from-[#2FB5AD] to-[#249E97]',
        buttonHover: 'hover:from-[#249E97] hover:to-[#1f8a80]',
        buttonShadow: 'shadow-[#2FB5AD]/25',
        inputFocus: 'focus:ring-[#2FB5AD]/20 focus:border-[#2FB5AD]',
        title: 'Inzalo EMS',
