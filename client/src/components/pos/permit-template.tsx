      ...
      <div className="p-8 font-sans max-w-[800px] mx-auto border-4 border-double border-gray-800 m-8">
        ...
        <div className="text-center mb-8 border-b-2 border-gray-800 pb-4">
          <div className="flex items-center justify-center gap-4 mb-4">
             ...
             <div>
                 <h1 className="text-3xl font-bold tracking-widest uppercase">{muniInfo?.name || 'George Municipality'}</h1>
        ...
        <div className="space-y-6 text-lg">
            ...
            <div className="flex justify-between border-b border-gray-300 pb-2">
                ...
                <span className="font-mono font-bold">{format(new Date(), 'dd MMM yyyy')}</span>
            </div>

            <div className="flex justify-between border-b border-gray-300 pb-2">
                <span className="font-bold uppercase text-gray-600">Valid Until:</span>
                <span className="font-mono font-bold">{format(new Date(new Date().setFullYear(new Date().getFullYear() + 1)), 'dd MMM yyyy')}</span>
            </div>
