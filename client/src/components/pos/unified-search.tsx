          ...
          <div className="w-full max-w-4xl mx-auto space-y-3">
              ...
              {advancedResults.length > 0 && (
                  <div className="bg-white rounded-lg border shadow-sm overflow-hidden">
                      <div className="bg-gradient-to-r from-[var(--pos-accent)] to-[var(--pos-accent-dark)] text-white px-4 py-2 text-sm font-medium">
                      ...
                      <div className="max-h-80 overflow-y-auto overflow-x-auto">
                          <table className="w-full text-sm min-w-[540px]" data-testid="table-advanced-results">
                              <thead className="bg-gradient-to-r from-[var(--pos-accent)] to-[var(--pos-accent-dark)] sticky top-0">
                                  <tr>
                              ...
                              <tbody>
                                  {advancedResults.map((acc: any, idx: number) => (
                                      <tr 
                                          ...
                                          className="border-t hover:bg-[var(--pos-accent-tint)] cursor-pointer transition-colors"
  ...
  return (
      ...
      <div className="flex gap-2 w-full max-w-2xl lg:max-w-4xl">
          ...
          <Button 
            variant="outline" 
            size="icon" 
            className="h-10 w-10 sm:h-12 sm:w-12 shrink-0 rounded-xl border-[#D6D6D6] bg-white hover:bg-[var(--pos-accent-tint)] hover:border-[var(--pos-accent)] transition-all"
            onClick={() => setShowAdvanced(true)}
            title="Advanced Search"
          >
            <Filter className="h-5 w-5 text-[var(--pos-accent)]" />
          </Button>
      </div>
